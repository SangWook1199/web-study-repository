...
<body>
	...
	<form method="get" action="FrontControllerServletVer2">
		<%-- 하나의 프론트 컨트롤러 다양한 요청이 이루어지므로 어떤 요청인지를
	 hidden으로 알린다
 --%>
		<input type="hidden" name="requestType" value="findbyid"> <input
			type="text" name="customerId" required="required" placeholder="고객아이디">
