 ...
 * 
 * 일반적으로 필요시 객체를 생성: Person p = new Person(); 와 같이 new 로 생성 Reflection API는
 * 런타임(프로그램 실행 중) 시에 동적 Dynamic 으로 객체를 생성, 제어하기 위한 기술
 */
public class ReflectionAPIUnitTest1 {
	public static void main(String[] args) {
		...
		//                          유지 보수성이 낮다 --> 패키지명을 동적으로 확보하는 방안으로 Test2를 구성
		try {
